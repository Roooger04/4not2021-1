...
// numero ao quadrado, use o operador ** ou a função Math.pow

// Caracteristicas desta função
// 1) Tem apenas 1 argumento
// 2) Seu corpo tem apenas uma linha de codigo, com return
function quadrado(n) {
    return n * n // n ** 2
}
...
// Quando não argumentos, os parentes marcam o lugar deles
